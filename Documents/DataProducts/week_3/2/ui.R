...
shinyUI(fluidPage
(
#     headerPanel(windowTitle = "SAVINGS CALCULATOR"),
sidebarLayout(position = "left",
    sidebarPanel
    (
        tabsetPanel(
            tabPanel(h4("RATES"),
                selectInput("iLocation", h3("LOCATION:"),
            ...
            ,tabPanel(h4("INC.BULBS")
                    ,selectInput("iIncandescent", h3("INCANDESCENT BULB:"),
                                         c("40 W INCANDESCENT","60 W INCANDESCENT"
                                           ,"75 W INCANDESCENT","100 W INCANDESCENT"
                                           ,"150 W INCANDESCENT"))
...
#         ,h4("oIncandescent:")
#         ,textOutput("oIncandescent")
#         ,h4("oQuantity:")
#         ,textOutput("oQuantity")
#         ,h4("oHours:")
#         ,textOutput("oHours")
#         ,h4("oRates:")
#         ,textOutput("oRates")
#         ,h4("oCFLLifetime:")
#         ,textOutput("oCFLLifetime")
...
# dateInput("id3","date")
# ,numericInput("glucose","Glucose level",90,min = 50,max = 200,step = 5))